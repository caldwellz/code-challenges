# code-challenges/opiniion-backend

An Opiniion Backend Challenge from September 13, 2024.

The description and requirements for the challenge were as follows:
